...
class Image_Read:
    ...
    def __init__(self, data, x, j, train=False):
        ...
        if train == True:
            ...
            x, y = train_glay(self.x[0], self.x[1], j)
        else:
        ...
        result = [key for key, val in list(Counter(channel_one_hot).items()) if val > 1]
