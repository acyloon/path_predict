...
'''----------------------------'''
SEGMENTATION_PATH_DATA = '../../Annotated-SDD/image/train/GLAY/*.png'
SEGMENTATION_PATH_TEST = '../../Annotated-SDD/image/test/GLAY/*.png'
'''----------------------------'''
...
def main():
    ...
    parser.add_argument('--i_size', type=int, default=296, help='number of input layer unit')
    ...
    for epoch in range(1, args.epoch + 1):
        ...
        for data_iter in range(0, len(data_train.all_data) - 5, args.batch):
            ...
            for batch_ in range(args.batch):
                ...
                print("scene_num:") #TODO: 同じを読み込んでいないか.
                print(list_random)
                # image load
                ...
                print("trajectory_num:") #TODO: 同じを読み込んでいないか.
                print(trajectory_random)
            ...
            for sequence in range(args.relate_coordinate):
                ...
                xy = x[:, sequence, :]
                training = t[:, sequence, :][:, :2]     # Don't use attributes in testing
