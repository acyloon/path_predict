...
class Model(chainer.Chain):
    ...
    def forward(self, img, x, t=None, train=False):
        h = F.max_pooling_2d(F.relu(F.local_response_normalization(self.conv1(img))), 2, stride=2)
        h = F.max_pooling_2d(F.relu(F.local_response_normalization(self.conv2(h))), 2, stride=2)
